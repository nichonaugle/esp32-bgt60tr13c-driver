...
// Chirp duration: T_RAMP_UP (133.5us for 256 samples) + T_SED_AFTER_SHAPE (500us from PLL1_7)
#define XENSIV_BGT60TR13C_CONF_CHIRP_DURATION_S (0.0001335)     // T_RAMP_UP Reverted
#define XENSIV_BGT60TR13C_CONF_PAUSE_AFTER_CHIRP_S (0.0005)  // T_SED from PLL1_7
